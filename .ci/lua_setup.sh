...
export PATH=$PATH:$LUAROCKS_INSTALL/bin #PATH=$PATH:$OPENRESTY_INSTALL/nginx/sbin:$OPENRESTY_INSTALL/bin:$LUAROCKS_INSTALL/bin:$SERF_INSTALL

eval `luarocks path`

luarocks install kong $KONG_VERSION --local
